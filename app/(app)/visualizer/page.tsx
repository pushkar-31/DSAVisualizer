...
import { BrainCircuit, Binary, TreePine, Box, List, ArrowLeftRight, Calculator, MessageSquare, Hash, ArrowRightLeft, Grid3X3 } from "lucide-react"
...
const sections = {
  dataStructures: [
    {
      name: "Array",
      description: "Fixed-size indexed structure offering O(1) random access.",
  ...
  sorting: [
    {
      ...
      description: "Visualize classic sorting algorithms step-by-step.",
    ...
    <div className="container py-8 max-w-7xl mx-auto">
      <div className="flex flex-col items-center text-center mb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-3xl font-bold tracking-tight">DSAinsight</h1>
        </div>
      ...
      <div className="space-y-12">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-6">Sorting Algorithms</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
